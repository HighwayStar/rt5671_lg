...
static const struct snd_kcontrol_new rt5671_snd_controls[] = {
	...
	SOC_SINGLE("RECMIXL INL1 Gain", RT5671_REC_L1_MIXER,
		RT5671_G_IN_L_RM_L_SFT, 6, 1),
	SOC_SINGLE("RECMIXL BST1 Gain", RT5671_REC_L2_MIXER,
		RT5671_G_BST1_RM_L_SFT, 6, 1),
	SOC_SINGLE("RECMIXL BST2 Gain", RT5671_REC_L1_MIXER,
		RT5671_G_BST2_RM_L_SFT, 6, 1),
	SOC_SINGLE("RECMIXL BST3 Gain", RT5671_REC_L1_MIXER,
		RT5671_G_BST3_RM_L_SFT, 6, 1),
	SOC_SINGLE("RECMIXL BST4 Gain", RT5671_REC_L1_MIXER,
		RT5671_G_BST4_RM_L_SFT, 6, 1),
	SOC_SINGLE("RECMIXR INR1 Gain", RT5671_REC_R1_MIXER,
		RT5671_G_IN_R_RM_R_SFT, 6, 1),
	SOC_SINGLE("RECMIXR BST1 Gain", RT5671_REC_R2_MIXER,
		RT5671_G_BST1_RM_R_SFT, 6, 1),
	SOC_SINGLE("RECMIXR BST2 Gain", RT5671_REC_R1_MIXER,
		RT5671_G_BST2_RM_R_SFT, 6, 1),
	SOC_SINGLE("RECMIXR BST3 Gain", RT5671_REC_R1_MIXER,
		RT5671_G_BST3_RM_R_SFT, 6, 1),
	SOC_SINGLE("RECMIXR BST4 Gain", RT5671_REC_R1_MIXER,
		RT5671_G_BST4_RM_R_SFT, 6, 1),	
	SOC_SINGLE("RECMIXM BST1 Gain", RT5671_REC_MONO2_MIXER,
		RT5671_G_BST1_RM_M_SFT, 6, 1),
	SOC_SINGLE("RECMIXM BST2 Gain", RT5671_REC_MONO1_MIXER,
		RT5671_G_BST2_RM_M_SFT, 6, 1),
	SOC_SINGLE("RECMIXM BST3 Gain", RT5671_REC_MONO1_MIXER,
		RT5671_G_BST3_RM_M_SFT, 6, 1),
	SOC_SINGLE("RECMIXM BST4 Gain", RT5671_REC_MONO1_MIXER,
		RT5671_G_BST4_RM_M_SFT, 6, 1),	
			...
			struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		reg_outmix = snd_soc_read(codec, RT5671_OUT_L1_MIXER);
		snd_soc_update_bits(codec, RT5671_OUT_L1_MIXER,
			 RT5671_M_DAC_L1_OM_L, RT5671_M_DAC_L1_OM_L);
		reg_hpmix = snd_soc_read(codec, RT5671_HPO_MIXER);
		snd_soc_update_bits(codec, RT5671_HPO_MIXER,
			 RT5671_M_DACL1_HML, RT5671_M_DACL1_HML);
		break;

	case SND_SOC_DAPM_POST_PMU:
		snd_soc_update_bits(codec, RT5671_OUT_L1_MIXER,
			 RT5671_M_DAC_L1_OM_L, reg_outmix);
		snd_soc_update_bits(codec, RT5671_HPO_MIXER,
			 RT5671_M_DACL1_HML, reg_hpmix);
		break;
			...
			struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		reg_outmix = snd_soc_read(codec, RT5671_OUT_R1_MIXER);
		snd_soc_update_bits(codec, RT5671_OUT_R1_MIXER,
			 RT5671_M_DAC_R1_OM_R, RT5671_M_DAC_R1_OM_R);
		reg_hpmix = snd_soc_read(codec, RT5671_HPO_MIXER);
		snd_soc_update_bits(codec, RT5671_HPO_MIXER,
			 RT5671_M_DACR1_HMR, RT5671_M_DACR1_HMR);
		break;

	case SND_SOC_DAPM_POST_PMU:
		snd_soc_update_bits(codec, RT5671_OUT_R1_MIXER,
			 RT5671_M_DAC_R1_OM_R, reg_outmix);
		snd_soc_update_bits(codec, RT5671_HPO_MIXER,
			 RT5671_M_DACR1_HMR, reg_hpmix);
		break;
			...
			struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_update_bits(codec, RT5671_OUT_L1_MIXER,
			 RT5671_M_DAC_L2_OM_L, reg_outmix);
		break;
			...
			struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_update_bits(codec, RT5671_OUT_R1_MIXER,
			 RT5671_M_DAC_R2_OM_R, reg_outmix);
		break;
...
static const struct snd_soc_dapm_widget rt5671_dapm_widgets[] = {
	...
	SND_SOC_DAPM_SUPPLY("dac stereo1 filter", RT5671_PWR_DIG2,
		RT5671_PWR_DAC_S1F_BIT, 0, rt5671_dac_filter_depop_event,
		SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
	SND_SOC_DAPM_SUPPLY("dac mono left filter", RT5671_PWR_DIG2,
		RT5671_PWR_DAC_MF_L_BIT, 0, rt5671_dac_monol_filter_depop_event,
		SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
	SND_SOC_DAPM_SUPPLY("dac mono right filter", RT5671_PWR_DIG2,
		RT5671_PWR_DAC_MF_R_BIT, 0, rt5671_dac_monor_filter_depop_event,
		SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
